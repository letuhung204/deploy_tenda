                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        <td colspan="1"><img alt="this is logo"
                            ...
                            <h2>Nhà Cung Cấp </h2> <spring:url value="/save-nha-cung-cap"
                                                                var="saveURL" />
                            <fieldset>
                                <form:form modelAttribute="nhaCungCap" method="POST"
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-2 requiredField">
                                            Tên Nhà Cung Cấp <span class="asteriskField"> *</span>
                                        </label>
                                        <div class="col-md-8 inputGroupContainer">
                                            <div class="input-group">
                                                    <span class="input-group-addon"><i
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-2 requiredField">
                                            Sô Điện Thoại <span class="asteriskField"> *</span>
                                        </label>
                                        <div class="col-md-8 inputGroupContainer">
                                            <div class="input-group">
                                                    <span class="input-group-addon"><i
                                                ...
                                                <form:input path="soDienThoai" id="soDienThoai"
                                                            placeholder="nhập số điện thoại nhà cung cấp" class="form-control"
                                                            required="true" type="text" ></form:input>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-sm-2 requiredField">
                                            Sô Fax <span class="asteriskField"> *</span>
                                        </label>
                                        <div class="col-md-8 inputGroupContainer">
                                            <div class="input-group">
                                                    <span class="input-group-addon"><i
                                                ...
                                                <form:input path="fax" id="fax"
                                                            placeholder="nhập fax nhà cung cấp" class="form-control"
                                                            required="true" type="text" ></form:input>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-8 inputGroupContainer">
                                            <div class="input-group">
                                                ...
                                                <form:input path="email" id="email"
                                                            placeholder="nhập email nhà cung cấp" class="form-control"
                                                            required="true" type="text" ></form:input>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-sm-2 requiredField">
                                            Địa Chỉ <span class="asteriskField"> *</span>
                                        </label>
                                        <div class="col-md-8 inputGroupContainer">
                                            <div class="input-group">
														<span class="input-group-addon"><i
                                                ...
                                                <form:textarea path="diaChi"
                                                               placeholder="nhập mô tả địa chỉ" class="form-control" rows="3"
